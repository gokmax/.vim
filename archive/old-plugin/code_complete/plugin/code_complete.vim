...
let g:template['c']['cs'] = "/*@@*/\<left>\<left>\<left>"
let g:template['c']['de'] = "#define "
let g:template['c']['in'] = "#include \""
let g:template['c']['is'] = "#include <"
...
let g:template['c']['main'] = "int main()\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
...
let g:template['c']['if'] = "if (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}\<cr>".g:rs."...".g:re
let g:template['c']['else'] = "else \<cr>{\<cr>".g:rs."...".g:re."\<cr>}\<cr>".g:rs."...".g:re
let g:template['c']['while'] = "while (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}\<cr>".g:rs."...".g:re

let g:template['c']['ife'] = "if (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>} else\<cr>{\<cr>".g:rs."...".
            \g:re."\<cr>}"
let g:template['c']['struct'] = "struct ".g:rs."...".g:re."\<cr>{\<cr>".g:rs."...".g:re."\<cr>};\<cr>".g:rs."...".g:re
let g:template['c']['class'] = "class ".g:rs."...".g:re."\<cr>{\<cr>".g:rs."...".g:re."\<cr>};\<cr>"
...
"  Java template
let g:template['java'] = {}
let g:template['java']['cc'] = "/*  */\<left>\<left>\<left>"
let g:template['java']['cd'] = "/**<  */\<left>\<left>\<left>"
let g:template['java']['for'] = "for (".g:rs."...".g:re."; ".g:rs."...".g:re."; ".g:rs."...".g:re.")\<cr>{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['java']['main'] = "public static void main(String[] args)\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['java']['switch'] = "switch (".g:rs."...".g:re.")\<cr>{\<cr>case ".g:rs."...".g:re." :\<cr>break;\<cr>case ".
            \g:rs."...".g:re." :\<cr>break;\<cr>default :\<cr>break;\<cr>}"
let g:template['java']['if'] = "if (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['java']['while'] = "while (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['java']['ife'] = "if (".g:rs."...".g:re.")\<cr>{\<cr>".g:rs."...".g:re."\<cr>} else\<cr>{\<cr>".g:rs."...".
            \g:re."\<cr>}"
...
let g:template['_']['xt'] = "\<c-r>=strftime(\"%c\")\<cr>"
"let g:template['_']['xt'] = "\<c-r>=strftime(\"%F %a %T  %z\")\<cr>"
