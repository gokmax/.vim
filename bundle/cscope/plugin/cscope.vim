...
"---------------------------------------------------------
map <leader>fs :call CscopeFind('n', 's', expand('<cword>'))<CR>
map <leader>fg :call CscopeFind('n', 'g', expand('<cword>'))<CR>
map <leader>fd :call CscopeFind('n', 'd', expand('<cword>'))<CR>
map <leader>fc :call CscopeFind('n', 'c', expand('<cword>'))<CR>
map <leader>ft :call CscopeFind('n', 't', expand('<cword>'))<CR>
map <leader>fe :call CscopeFind('n', 'e', expand('<cword>'))<CR>
map <leader>ff :call CscopeFind('n', 'f', expand('<cword>'))<CR>
map <leader>fi :call CscopeFind('n', 'i', expand('<cword>'))<CR>

"                 Split Buffer Horizontally:
"---------------------------------------------------------
map <leader>sfs :call CscopeFind('s', 's', expand('<cword>'))<CR>
map <leader>sfg :call CscopeFind('s', 'g', expand('<cword>'))<CR>
map <leader>sfd :call CscopeFind('s', 'd', expand('<cword>'))<CR>
map <leader>sfc :call CscopeFind('s', 'c', expand('<cword>'))<CR>
map <leader>sft :call CscopeFind('s', 't', expand('<cword>'))<CR>
map <leader>sfe :call CscopeFind('s', 'e', expand('<cword>'))<CR>
map <leader>sff :call CscopeFind('s', 'f', expand('<cword>'))<CR>
map <leader>sfi :call CscopeFind('s', 'i', expand('<cword>'))<CR>

"                 Split Buffer Vertically:
"---------------------------------------------------------
map <leader>vfs :call CscopeFind('v', 's', expand('<cword>'))<CR>
map <leader>vfg :call CscopeFind('v', 'g', expand('<cword>'))<CR>
map <leader>vfd :call CscopeFind('v', 'd', expand('<cword>'))<CR>
map <leader>vfc :call CscopeFind('v', 'c', expand('<cword>'))<CR>
map <leader>vft :call CscopeFind('v', 't', expand('<cword>'))<CR>
map <leader>vfe :call CscopeFind('v', 'e', expand('<cword>'))<CR>
map <leader>vff :call CscopeFind('v', 'f', expand('<cword>'))<CR>
map <leader>vfi :call CscopeFind('v', 'i', expand('<cword>'))<CR>
